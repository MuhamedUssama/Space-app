class Planet {
  ...
  static List<Planet> planets = [
    ...
    Planet(
      ...
      about:
          "Mercury is the closest planet to the Sun and the smallest in our solar system. It has a thin atmosphere and extreme temperature variations due to its proximity to the Sun and slow rotation.",
